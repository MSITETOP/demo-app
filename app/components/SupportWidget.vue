...
<template>
    <B24Slideover :b24ui="{ header: 'support-widget-header', body: 'support-widget-body' }" :side="store.modeView === 'mobile' ? 'top' : 'right'">
...
<style>
    ...
    .cust-widget .puls {
        ...
        border-radius: 50%;
        animation: custWidgetPuls infinite 1.5s;
    }
    .cust-widget .icon-container {
        position: relative;
        display: flex;
        align-items: center;
        ...
        cursor: pointer;
        transition: all .2s;
        outline: 0 solid #A5E9FF;
    }
    .cust-widget .icon-container:hover {
        outline-width: 5px;
    }

    @keyframes custWidgetPuls {
        50% {
